...
class HHSummary(Base):
    ...
    #     this table would be the summary generated by the primary extract process and the instantiation of the update/migration cron job
    ...
    #     ## profile attributes
    #     total_spend = Column(Float)# total spend
    #         # Column(Float)# spend by category?

    #     num_baskets = Column(Integer)# number of purchases/baskets
    #     first_purchase = Column(Integer) # days since first purchase

    #     # date of first purchase #Column(dt.datetime)
    ...
    #     # table metadata...? store elsewhere
    #     # last_updated = Column(dt.datetime)
